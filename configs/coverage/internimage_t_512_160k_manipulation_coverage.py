...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/coverage_val.py',
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_4k.py',
]
pretrained = 'work_dirs/upernet_internimage_t_512_160k_manipulation_focal_baseline/best_mIoU_iter_160000.pth'
