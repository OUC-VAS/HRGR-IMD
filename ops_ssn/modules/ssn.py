...
from ..functions import PairwiseDistFunction
from ..functions import SPixel2DToAdjMatrixFunction, SPixel3DToAdjMatrixFunction
...
def spixel2d_to_adj_maxtrix(input: torch.Tensor, n_pixel: int):
    return SPixel2DToAdjMatrixFunction.apply(input, n_pixel)

def spixel3d_to_adj_maxtrix(input: torch.Tensor, n_pixel: int):
    return SPixel3DToAdjMatrixFunction.apply(input, n_pixel)
