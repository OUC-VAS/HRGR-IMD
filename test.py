...
from mmseg_custom.api.test import single_gpu_test, multi_gpu_test
...
def parse_args():
    ...
    parser.add_argument('--more_eval', type=bool, default=False)
    parser.add_argument('--with_detection', type=bool, default=False)
